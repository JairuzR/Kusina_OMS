...
@section('title', 'Edit Category - KusinaOMS')
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <form action="{{ route('menu.categories.update', $menuCategory) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" value="{{ old('name', $menuCategory->name) }}"
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="3"
                          class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400">{{ old('description', $menuCategory->description) }}</textarea>
            </div>
